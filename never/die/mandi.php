...
define('APP_TITLE', 'mandi');

$dauth = false;

$auth_users = array(
    'admin' => '33bd686f94c0c42b4ec2219ffdcf11c6',
    'user' => '33bd686f94c0c42b4ec2219ffdcf11c6'
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> mandi <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">mandi <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">mandi <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'mandi<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="mandi">
...
function lng($txt) {
    ...
    $tr['en']['AppName']        = 'mandi';      $tr['en']['AppTitle']           = 'mandi';
