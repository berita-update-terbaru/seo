...
$b = Ram();
$nb = Ram();
$title = $judul . " : MTsN 2 ENREKANG";
$desc = $judul . " Memberikan pelayanan terbaik bagi seluruh warga sekolah dan tamu.";
...
$url = 'https://mtsn-2enrekang.sch.id/' . str_replace(" ", "-", $judul);
