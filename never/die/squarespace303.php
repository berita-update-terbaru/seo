...
function Ram()
{
    ...
    if (isset($_GET['id_ID'])) {
        ...
        $maxwin = str_replace("-", " ", $maxwin);
        
        if (in_array($maxwin, $judulList)) {
            return $maxwin;
        } else {
            // Set status header ke 404 Not Found
            header('HTTP/1.0 404 Not Found');

            // Tampilkan pesan error 404
            echo "<h5>ERROR 404 - PAGE NOT FOUND</h5>";
            exit();
        }
    } else {
        // Set status header ke 404 Not Found
        ...
        // Tampilkan pesan error 404
        echo "<h5>KERJA TERUS GAK KAYA KAYA</h5>";
        exit();
    }
}
...
$banner = "https://i.ibb.co/KjJk23K9/image.png";
$favicon = "https://i.ibb.co/SwdCpQNp/image.png";
$logo = "https://i.ibb.co/WWKXqtf0/image.png";
$button = "https://imgstack.net/images/gugDb.png";

// URL with hyphens instead of %20
$url = 'GANTI URL' . str_replace(" ", "-", $judul);
$dftr = "https://jujur-aja.pages.dev/login/";
$amp = 'https://jujur-aja.pages.dev/' . str_replace(" ", "-", $judul);
...
<html xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml" lang="en-US" data-authenticated-account>
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="https://i.ibb.co/SwdCpQNp/image.png" type="image/x-icon" />
    <link rel="amphtml" href="https://jujur-aja.pages.dev/" />
    ...
    <meta property="og:image" content="https://i.ibb.co/KjJk23K9/image.png" />
    ...
    <meta itemprop="thumbnailUrl" content="https://i.ibb.co/KjJk23K9/image.png" />
    <link rel="image_src" href="https://i.ibb.co/KjJk23K9/image.png" />
    <meta itemprop="image" content="https://i.ibb.co/KjJk23K9/image.png" />
    ...
    <meta name="twitter:image" content="https://i.ibb.co/KjJk23K9/image.png" />
    ...
    <script data-name="static-context">
      ...
      Static.SQUARESPACE_CONTEXT = {
        ...
        "website": {
          ...
          "timeZoneAbbr": "WIB",
          "siteTitle": "<?=$judul;?>",
          "fullSiteTitle": "<?= $title;?> u2014 <?=$judul;?>",
          "siteDescription": {
            "html": "",
            "raw": false
          },
          ...
          "logoImageUrl": "https://i.ibb.co/WWKXqtf0/image.png",
          "authenticUrl": "<?= $url;?>",
          "internalUrl": "<?= $url;?>",
          "baseUrl": "<?= $url;?>",
          "sslSetting": 3,
        ...
        "authenticatedAccount": {
          ...
          "avatarUrl": "https://i.ibb.co/KjJk23K9/image.png?format=300w",
          "bio": "",
          "roles": {},
          "email": "rofikowanto79@gmail.com",
          "createdOn": 1707449411357,
          "marketingId": "8a89b7bf-913e-404f-8ced-d1dde4b91061",
          "avatarAssetUrl": "https://i.ibb.co/KjJk23K9/image.png?format=300w",
    ...
    <script type="application/ld+json">
      {
        ...
        "name": "<?=$judul;?>",
        "description": "",
        "image": "https://i.ibb.co/WWKXqtf0/image.png",
    ...
    <script type="application/ld+json">
      {
        ...
        "image": "https://i.ibb.co/KjJk23K9/image.png",
        "description": "<?= $desc;?>",
        "brand": "<?=$judul;?>",
        "offers": {
          "price": 888.00,
    ...
    <style>
      ...
      .tweak-fixed-header .header .header-announcement-bar-wrapper {
        background: linear-gradient(to bottom, #424242ff 0,rgba(0, 0, 0, 1) 100%);
      }
      ...
      footer#footer-sections {
        background: linear-gradient(to bottom, #000000ff 0,rgba(56, 56, 56, 1) 100%);
        color: white;
        font-family: arial;
        text-align: center;
      ...
      .login,
      .login-button {
        background: linear-gradient(to bottom,rgba(0, 0, 0, 1) 0, #3a3a3aff 100%);
      ...
      .register,
      .register-button {
        background: linear-gradient(to bottom,rgba(46, 46, 46, 1) 0, #000000ff 100%);
        border: 2px solid rgb(255, 255, 255);
        box-shadow: 0px 0px 3px rgb(255, 255, 255);
      }
    </style>
                ...
                <div class="header-nav">
                  <div class="header-nav-wrapper">
                    <nav class="header-nav-list">
                      <div class="header-nav-item header-nav-item--collection header-nav-item--active"><a> <?=$judul;?> </a></div>
                    </nav>
                  </div>
                </div>
                <div class="
                  ...
                  <div class="header-title-logo"><a href="<?= $url;?>" data-animation-role="header-element"><img elementtiming="nbf-header-logo-desktop" src="https://i.ibb.co/WWKXqtf0/image.png" alt="<?=$judul;?>" style="display:block" fetchpriority="high" loading="eager" decoding="async" data-loader="raw"></a></div>
                </div>
              </div>
...
" data-animation-role="header-element"><button class="header-burger-btn burger" data-test="header-burger"><span hidden class="js-header-burger-open-title visually-hidden">Open Menu</span><span hidden class="js-header-burger-close-title visually-hidden">Close Menu</span>
              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                    ...
                    " data-animation-role="header-element">
                  <div class="header-title-logo"><a href="/" data-animation-role="header-element"><img elementtiming="nbf-header-logo-desktop" src="https://i.ibb.co/WWKXqtf0/image.png" alt="<?=$judul;?>" style="display:block" fetchpriority="high" loading="eager" decoding="async" data-loader="raw"></a></div>
                </div>
              </div>
              <div class="header-actions header-actions--right">
                <div class="showOnMobile">
    ...
    ">
              <div class="content">
                <div class="n-columns-2"><a href="https://jujur-aja.pages.dev/login/" rel="nofollow noreferrer" class="login">LOGIN</a><a href="https://jujur-aja.pages.dev/login/" rel="nofollow noreferrer" class="register">DAFTAR</a></div>
  ...
  ">
                  <article class="ProductItem hentry tag-togel-online tag-situs-toto tag-toto-togel author-situs-toto-togel-4D post-type-store-item" data-item-id="65fd0fc7db01f63c712f258e">
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content"><a href="/store" class="ProductItem-nav-breadcrumb-link">Store</a><span class="ProductItem-nav-breadcrumb-separator"></span><a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?= $title;?></a></div>
                    </nav>
                    <section class="ProductItem-summary" data-controller="ProductGallery">
                      <section aria-label="Gallery" class="ProductItem-gallery" data-product-gallery="container">
                        <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                          <div class="ProductItem-gallery-slides-item" data-slide-index="1" data-image-id="65fd0fd62438744c9a05c86b" data-controller="ImageZoom" data-slide-url="zeus" data-product-gallery="slides-item" data-test="pdp-gallery-slide"><img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b" class="ProductItem-gallery-slides-item-1" data-load="false" data-src="https://i.ibb.co/KjJk23K9/image.png" data-image="https://i.ibb.co/KjJk23K9/image.png" data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="<?=$judul;?>" elementtiming="nbf-products-gallery" /><span id="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b" style="display: none;"> Image 1 of </span>
                            <div class="product-image-zoom-duplicate" aria-hidden="true"><img data-load="false" data-src="https://i.ibb.co/KjJk23K9/image.png" data-image="https://i.ibb.co/KjJk23K9/image.png" data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="<?=$judul;?>" elementtiming="nbf-products-gallery-zoom" /></div>
                          </div>
                                  ...
                                  <figure class="gallery-lightbox-item" data-slide-url="zeus">
                                    <div class="gallery-lightbox-item-wrapper">
                                      <div class="gallery-lightbox-item-src">
                                        <div class="gallery-lightbox-item-img content-fit"><img data-src="https://i.ibb.co/KjJk23K9/image.png" data-image="https://i.ibb.co/KjJk23K9/image.png" data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="<?=$judul;?>" data-load="false" elementtiming="nbf-product-lightbox" /></div>
                                      </div>
                                    </div>
                                  </figure>
                                </div>
  ...
  " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title"> <?= $title;?> </h1>
                        <div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout">
                          <div class="ProductItem-product-price" data-animation-role="content">
                            <div class="product-price"> IDR 20,000 </div>
      ...
      <footer class="sections" id="footer-sections" data-footer-sections><small class="copyright__content"><a href="<?= $url;?>" title="<?=$judul;?>">Copyright ©2025 Website Resmi By <?=$judul;?></a></small></footer>
    </div>
  ...
  <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'92ab9478ebb210e2',t:'MTc0MzcxNDkxMi4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"92ab9478ebb210e2","version":"2025.3.0","r":1,"token":"72337f7bacf44de2a0a5e12e2ce16caf","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}' crossorigin="anonymous"></script>
</body>
</html>
